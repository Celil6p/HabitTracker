...
const HabitTracker: React.FC = () => {
  ...
  const [habits, setHabits] = useState<HabitsState>(() => {
    ...
    if (savedHabits) {
      ...
      // Convert regular objects back to Sets
    ...
    <div className="p-4 max-w-5xl mx-auto">
      ...
      <div className="hidden print:block">
        {months.map((month, index) => (
          <div key={month} className="page-break-before">
            <h2 className="text-2xl font-semibold text-gray-700 mb-6">{month}</h2>
            <div className="grid grid-cols-7 gap-2 bg-white p-4 rounded-lg shadow">
              ...
              {[...Array(daysInMonth[index])].map((_, day) => (
                <DayCell
                  key={day}
                  monthIndex={index}
                  day={day + 1}
      ...
      <div className="mt-6 text-gray-600">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>PDF olarak kaydet butonu ile tüm ayları yazdırabilirsiniz</li>
        </ul>
      </div>
    </div>
  );
